...
class SummaryPenjualanWizard(models.TransientModel):
    _name = "summary.penjualan.wizard"
    _description = "Summary Penjualan Wizard"
    ...
    def action_print_kartu(self):
        ...
        return self.env.ref('accounting_excel_report.report_summary_penjualan_xlsx').report_action(self, data=data)
